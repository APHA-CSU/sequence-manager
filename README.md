...
Error information is automatically logged and uploaded to `s3://s3-csu-001/logs/bcl-manager.log` in the event of processing failure. The available space on `wey-001` is also reported at the end of each run.
